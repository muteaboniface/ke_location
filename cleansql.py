# array containing the id, county id sub_county and ward
sql_dump = [
...
(256, 12, 'igembe central', 'akirangondu', ''),
...
(301, 13, 'chuka/igambangom', 'mariani', ''),
(302, 13, 'chuka/igambangom', 'karingani', ''),
(303, 13, 'chuka/igambangom', 'magumoni', ''),
(304, 13, 'chuka/igambangom', 'mugwe', ''),
(305, 13, 'chuka/igambangom', 'igambangombe', ''),
...
(625, 23, 'turkana central', 'kangatotha', ''),
...
(737, 28, 'marakwet west', 'cherangany/chebororwa', ''),
...
(763, 29, 'nandi hills', 'ollessos', ''),
(764, 29, 'nandi hills', 'kapchorua', ''),
(765, 29, 'chesumei', 'chemundu/kapngetuny', ''),
...
(929, 34, 'kajiado west', 'ewuaso oonkidongi', ''),
...
(1101, 39, 'kanduyi', 'east sangalo', ''),
(1102, 39, 'kanduyi', 'marakaru/tuuti', ''),
(1103, 39, 'kanduyi', 'sangalo west', ''),
...
(1123, 40, 'teso north', 'angurai south', ''),
(1124, 40, 'teso north', 'angurai north', ''),
(1125, 40, 'teso north', 'angurai east', ''),
(1126, 40, 'teso north', 'malaba south', ''),
(1127, 40, 'teso south', 'angorom', ''),
...
(1150, 40, 'funyula', 'agenga nanguba', ''),
...
(1213, 42, 'muhoroni', 'masogo/nyangoma', ''),
...
(1306, 45, 'south mugirango', 'boikanga', ''),
...
# Extracct wards from subcounties
ward_out_file = open("wards.sql","a")
subcounty_out_file = open("subcounty.sql","a")
...
for i in sql_dump:
    if i[2] == prev_sub_c:
        # retain sub_c_id
        # sbs = "("+str(sub_c_id)+","+str(i[1])+","+str(i[2])+"),"
        wrds = "("+str(ward_id)+","+str(sub_c_id)+","+"'"+str(i[3])+"'"+"),\n"

        # subcounty_out_file.write(sbs)
        ward_out_file.write(wrds)
        ward_id += 1
        prev_sub_c = i[2]
        continue
    else:
        if ward_id != 1: # exclude initial loop
            sub_c_id += 1
        

        sbs = "("+str(incr)+","+str(i[1])+","+"'"+str(i[2])+"'"+"),\n"
        wrds = "("+str(ward_id)+","+str(sub_c_id)+","+"'"+str(i[3])+"'"+"),\n"
